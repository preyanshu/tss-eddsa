...
export class MPCService {
  ...
  constructKeypair(
    ...
    return {
      sharedKey: {
        ...
        prefix: this.sharedKey.prefix
          ? serialization.serializeForHttp(this.sharedKey.prefix)
          : undefined,
      },
    };
  }
  ...
  createEphemeralKey(
    ...
    const messageArray = Buffer.isBuffer(messageNormalized)
      ? Array.from(messageNormalized)
      : messageNormalized;
  ...
  startEphemeralKeyGeneration(
    ...
    const messageArray = Buffer.isBuffer(messageBuffer)
      ? Array.from(messageBuffer)
      : messageBuffer;
